...
【readme_en.txtの免責】
readme_en.txtは機械翻訳を使ってREADME.mdを翻訳したものです。（Google翻訳）
内容についてはREADME.mdの方が優先されます。
翻訳の不備、その他何らかの問題により内容に違いがある場合は、README.mdが優先されます。
readme_en.txtは利便性のために用意されていることに注意してください。
[Disclaimer for readme_en.txt]
readme_en.txt is a machine translation of README.md. (Google Translate)
README.md takes precedence in terms of content.
If there are any differences in content due to translation errors or other issues, README.md takes precedence.
